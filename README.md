...
This repository contains multiple **Front-End projects**, each located in its own directory.  
The projects focus on building **clean UI**, **responsive layouts**, and **interactive web applications**.
...
All projects are deployed using **GitHub Pages** (or other hosting platforms).  
Click the **Live Demo** links above to preview each project.
